...
export default function App() {
  ...
  const { ref: canvasref, captureVideo } = useCanvas();

  return (
    <div>
      <Canvas {...{ canvasref }} />

      <video crossOrigin="anonymous" ref={videoRef} controls preload="metadata">
        <source
      ...
      ></object>
      <embed
        src="https://www.youtube.com/embed/nfk6sCzRTbM?autoplay=1"
        width="640"
        height="480"
      ...
      <button
        onClick={async () =>
          await captureVideo(videoRef.current, slicedRef.current)
        }
      >
        Capture Image
      </button>
